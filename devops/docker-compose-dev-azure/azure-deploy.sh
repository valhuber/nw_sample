...
resourcename="nwsample"  # lower case, only
resourcegroup="nwsample_rg"
...
# git clone https://github.com/apilogicserver/nwsample.git
# cd nwsample
...
az container create --resource-group nwsample_rg --name nwsample --image apilogicserver/nwsample:latest --dns-name-label nwsample --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//nwsample.westus.azurecontainer.io:5656'
