...
#
#    (v 14.03.22, March 25, 2025 19:54:23)
#
...
api_logic_server__version = '14.03.22'
api_logic_server_created__on = 'March 25, 2025 19:54:23'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 14.03.22\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 14.03.22\n'
    msg += f'.. startup message: {start_up_message}\n'
